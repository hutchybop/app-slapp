    ...
    if (newIng.checkValidity() === false) {
        ...
        for (let v of ingredientName) {
            if (v.value === newIngredientUpper) {
                ...
                newIngAlert.classList.remove('alert-warning', 'alert-success', 'newIngAlert')
...
addedDiv.addEventListener('click', function (e) {
    ...
    if (e.target.className === "fas fa-trash-alt") {
        ...
        const name = e.target.previousElementSibling.previousElementSibling.previousElementSibling.value
        ...
        removeAlert.classList.remove('alert-warning', 'alert-success', 'removeAlert')
